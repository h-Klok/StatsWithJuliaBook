...
println("Model 1 coefficients:", coef(model1))
println("Model 2 coefficients:", coef(model2))
println("Model 3 coefficients:", coef(model3))
println("Model 4 coefficients:", coef(model4))